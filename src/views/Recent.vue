  ...
  <div class="container">
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s4">
          <router-link to="photodetails"><img class="responsive-img hoverable" src="img/footbridge_small.jpg"></router-link>
        </div>
        <div class="col s4">
          <router-link to="photodetails"><img class="responsive-img hoverable" src="img/greenway_small.jpg"></router-link>
        </div>
      </div>
      <div class="row">
        <div class="col s4">
        ...
        <div class="col s4">
          <router-link to="photodetails"><img class="responsive-img hoverable" src="img/springfield_small.jpg"></router-link>
        </div>
      </div>
      <div class="row">
        <div class="col s4 offset-s4">
          <router-link to="photodetails"><img class="responsive-img hoverable" src="img/tumbler_small.jpg"></router-link>
        </div>
      </div>
    </div>
  </div>
